...
private ColorValidator() {
     ...
     * @param hls Another double[] object.
     * @return A double[] object.
     * @throws NullPointerException The parameter {@code hls} is null.
     */
    public static double[] HlsToRgb(double[] hls) {
      ...
      if (3 > hls.length) {
        throw new IllegalArgumentException("3 more than " + hls.length + " (3)");
      }
     ...
     * @return A double[] object.
     * @throws NullPointerException The parameter {@code x} is null.
     */
    ...
    private static HashMap<String, String> ColorToRgbaNamedColors =
      ColorToRgbaSetUpNamedColors();
    ...
    private static HashMap<String, String> ColorToRgbaSetUpNamedColors() {
      HashMap<String, String> ColorToRgbaNamedColors = new
     ...
     * applicable.
     * @param arrayRGB A double[] object.
    ...
    public static String RgbToColor(double[] arrayRGB) {
      ...
      if (3 > arrayRGB.length) {
        throw new IllegalArgumentException("3 more than " + arrayRGB.length + " (3)");
      }
   ...
   if ((arrayRGB.length > 3 && (arrayRGB[3] == 255)) || arrayRGB.length == 3) {
    ...
    public static String RgbToColorDisplay(double[] rgb) {
      ...
      if (3 > rgb.length) {
        throw new IllegalArgumentException("3 more than " + rgb.length + " (3)");
      }
    ...
    public static String RgbToColorHtml(double[] rgb) {
      ...
      int c;
      c = ((c = (int)StrictMath.round(rgb[0])) <
        0 ? 0 : (c > 255 ? 255 : c));
      sb.append(HexArray.charAt((c >> 4) & 15));
      sb.append(HexArray.charAt((c) & 15));
      c = ((c = (int)StrictMath.round(rgb[1])) <
        0 ? 0 : (c > 255 ? 255 : c));
      sb.append(HexArray.charAt((c >> 4) & 15));
      sb.append(HexArray.charAt((c) & 15));
      c = ((c = (int)StrictMath.round(rgb[2])) <
        0 ? 0 : (c > 255 ? 255 : c));
      sb.append(HexArray.charAt((c >> 4) & 15));
      sb.append(HexArray.charAt((c) & 15));
      return sb.toString();
     ...
     * @param r A 64-bit floating-point number.
     * @param g Another 64-bit floating-point number.
    ...
    public static String RgbToColorHtml(double r, double g, double b) {
      StringBuilder sb = new StringBuilder();
      int c;
      c = ((c = (int)StrictMath.round(r)) < 0 ? 0 :
          (c > 255 ? 255 : c));
      sb.append(HexArray.charAt((c >> 4) & 15));
      sb.append(HexArray.charAt((c) & 15));
      c = ((c = (int)StrictMath.round(g)) < 0 ? 0 :
          (c > 255 ? 255 : c));
      sb.append(HexArray.charAt((c >> 4) & 15));
      sb.append(HexArray.charAt((c) & 15));
      c = ((c = (int)StrictMath.round(b)) < 0 ? 0 :
          (c > 255 ? 255 : c));
      sb.append(HexArray.charAt((c >> 4) & 15));
      sb.append(HexArray.charAt((c) & 15));
      return sb.toString();
