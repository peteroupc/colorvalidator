...
private ColorValidator() {
        ...
        public static double[] HlsToRgb(double[] hls) {
            if ((hls) == null) {
 throw new NullPointerException("hls");
}
            if (3 > hls.length) {
 throw new IllegalArgumentException("3 more than " + Long.toString((long)(hls.length)) + " (3)");
}
 ...
 bl = a;
    ...
    /**
     * Converts HTML colors to Red/Green/Blue colors.&quot;color&quot;
     * is an HTML color or color name (ex. #223344, #234, or royalblue).getAll()
     * strings are treated as valid.Returns a 4-element array containing
     * the red, green, blue, and alpha(each 0-255); the alpha is always 255.
 ...
 return null;
                ...
                if (Double.isNaN(r1) || Double.isNaN(r2) || Double.isNaN(r3) || Double.isNaN(r4)) {
 return null;
}
 ...
 return new double[] { 0, 0, 0, 0 };
     ...
     * or HSLA (ex. #223344 or #234 or royalblue or rgb(20, 20, 20) or hsl(100,
     * 100%, 50%)).
 ...
 throw new IllegalArgumentException("3 more than " + Long.toString((long)(arrayRGB.length)) + " (3)");
}
     ...
     * @throws java.lang.IllegalArgumentException The parameter {@code rgb} is
     * null or contains fewer than three elements.
     */
 ...
 throw new NullPointerException("rgb");
            ...
            if (3 > rgb.length) {
 throw new IllegalArgumentException("3 more than " + Long.toString((long)(rgb.length)) + " (3)");
}
    ...
    /**
     * Converts an RGBA color to an HTML color, (ex. #002233).&quot;rgb&quot;
