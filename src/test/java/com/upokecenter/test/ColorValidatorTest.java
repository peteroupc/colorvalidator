...
if (ColorValidator.ColorToRgba(item) == null)Assert.fail(item);
item = "hsL(3+.49(06673,G540439%\fb,\f2982.getC2(),w3934%\n\t \n \t\f\f\n\n\f)";
if (ColorValidator.ColorToRgba(item) == null)Assert.fail(item);
item = "o0%im";
if (ColorValidator.ColorToRgba(item) == null)Assert.fail(item);
item = "RgB(\n\r\f\f\n\f4,+24446\n,+w535U31\f\t\f\n) ";
...
item = "VeneR";
if (ColorValidator.ColorToRgba(item) == null)Assert.fail(item);
item = "RCgB(+.73L7902288-%,\n\r\f\t\r96.getG76()%r,-1146r492089%\r)";
if (ColorValidator.ColorToRgba(item) == null)Assert.fail(item);
...
item = "4rgB4401766.47% \t\n,-.784748)% \f\n\f\r(\f.\t,\f\f\n\n4666%\n\r\f\t\f\f\r";
if (ColorValidator.ColorToRgba(item) == null)Assert.fail(item);
item = "HSL(s +30234\n\rG\r\f\n\n,\t956147.85l3 l25%, \t\r506701682.getF12()%\f)";
if (ColorValidator.ColorToRgba(item) == null)Assert.fail(item);
item = " \n\fpAPF(A\n9hS\n";
if (ColorValidator.ColorToRgba(item) == null)Assert.fail(item);
item = "#dDdMu1bEC8\fw";
