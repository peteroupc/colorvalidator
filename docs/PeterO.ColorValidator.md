...
3. RGB notation:  `rgb(20, 30, 40)`  or  `rgba(20, 30,
            40, 50%)` . (See _What is RGB notation?_, later.)

4. HSL notation:  `hsl(200, 100%, 50%)`  or  `hsla(200,
            100%, 50%, 80%` . (See _What is HSL notation?_, later.)
...
An alternative syntax for HSL colors supports the alpha component (see next question): in the example  `hsla(240, 100%,
...
An array containing four elements, with the red, green, blue, and alpha components of the same color, each from 0 to 255. Returns null if  <i>colorString</i>
